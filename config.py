...
def get_config():
    ...
    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default="ppo", choices=["rmappo", "mappo", "ppo", "rppo"])
    ...
    # ppo parameters
    parser.add_argument("--ppo_epoch", type=int, default=3, help="number of ppo epochs (default: 15)")
    parser.add_argument(
        "--use_clipped_value_loss",
        action="store_false",
        default=True,
