from .distributions import Bernoulli, Categorical, DiagGaussianV2
import torch
...
class ACTLayer(nn.Module):
    ...
    def __init__(self, action_space, inputs_dim, use_orthogonal, gain, device):
        ...
        if action_space.__class__.__name__ == "Discrete":
            ...
            self.action_out = DiagGaussianV2(inputs_dim, action_dim, action_space.low, action_space.high,
            ...
            self.action_outs = nn.ModuleList([DiagGaussianV2(inputs_dim, continous_dim, use_orthogonal, gain), Categorical(
