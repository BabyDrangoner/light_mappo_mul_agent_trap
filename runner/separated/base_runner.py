...
class Runner(object):
    def __init__(self, config):
        ...
        if self.algorithm_name == "mappo" or self.algorithm_name == "rmappo":
        ...
        elif self.algorithm_name == "ppo" or self.algorithm_name == "rppo":
            from algorithms.algorithm.ppo import PPO as TrainAlgo
            from algorithms.algorithm.PPOPolicy import PPOPolicy as Policy
