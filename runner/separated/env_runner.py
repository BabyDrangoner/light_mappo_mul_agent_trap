...
from scripts.plot.plotting import plotting
    ...
    def render(self):
        ...
        for episode in range(self.all_args.render_episodes):
            ...
            for step in range(self.episode_length):
                ...
                infos = infos.reshape(2, 4)
                self.plotting.plot_agents(infos[:, 0:3], infos[:, 3:])

            episode_rewards = np.array(episode_rewards)
            for agent_id in range(self.num_agents):
                # ep_rewards = episode_rewards[:, :, agent_id]
                # sum_rewards = np.sum(ep_rewards, axis=0)
